    ...
    <section className="relative min-h-screen flex items-center justify-center bg-dark-bg text-white pt-16">
      <div className="absolute inset-0 overflow-hidden z-10" style={{ top: "64px" }}>
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-15">
          ...
          <div className="absolute -left-40 top-1/3 w-96 h-96 bg-accent opacity-20 rounded-full blur-3xl"></div>
        </div>
      ...
      <div className="container z-20 px-4 md:px-6 text-center">
        ...
        <motion.p 
          className="subtitle-text text-white opacity-90 max-w-3xl mx-auto mb-10 font-medium leading-relaxed"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <a 
            href="#services" 
            className="btn-accent text-lg px-8 py-3 rounded-md font-medium inline-block text-primary"
          >
