              ...
              {index % 2 === 0 ? (
                <>
                  <div className="md:col-span-8">
                    ...
                    <p className="text-gray-600 text-lg font-normal leading-relaxed">{service.description}</p>
                  </div>
                  <div className="md:col-span-4">
                    {index === 0 ? (
                      ...
                      <div className="rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-primary to-primary-light h-48 flex items-center justify-center">
                        <div className="text-white text-5xl font-bold opacity-60">{index + 1}</div>
                      </div>
                    )}
                  </div>
                </>
                ...
                <>
                  <div className="md:col-span-4 order-2 md:order-1">
                    <div className="rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-secondary to-secondary h-48 flex items-center justify-center">
                      <div className="text-white text-5xl font-bold opacity-60">{index + 1}</div>
                    </div>
                  </div>
